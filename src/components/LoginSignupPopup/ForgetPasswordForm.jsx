...
const ForgetPasswordForm = ({ onClose }) => {
  ...
  const { forgetPassword, changePassword } = useContext(AuthContext);
  ...
  const handleChangePassword = async (event) => {
    ...
    const passChanged = await changePassword(phoneNumber, newPass, confirmationCode);
  ...
  return (
    <>
        ...
        <hr style={{ margin: '16px auto', width: '90%', borderColor: 'rgba(0, 0, 0, 0.2)' }} />
      {
        ...
        <>
          <Typography variant="body1" mb={1}>کد ارسال شده را وارد کنید</Typography>
          <TextField
            variant="outlined"
            type='text'
          ...
          <Typography variant="body1" mb={1}>رمز عبور جدید:</Typography>
          <TextField
              variant="outlined"
          ...
          <Typography variant="body1" mb={1}>تکرار رمز عبور جدید:</Typography>
          <TextField
              variant="outlined"
