		...
		>
			...
			>
				...
				>
					...
					>
						<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
							<path d="M1.25 7.99805C1.25 4.8158 1.25 3.22505 2.2385 2.23655C3.227 1.24805 4.8185 1.24805 8 1.24805C11.1823 1.24805 12.773 1.24805 13.7615 2.23655C14.75 3.22505 14.75 4.81655 14.75 7.99805C14.75 11.1803 14.75 12.771 13.7615 13.7595C12.773 14.748 11.1815 14.748 8 14.748C4.81775 14.748 3.227 14.748 2.2385 13.7595C1.25 12.771 1.25 11.1795 1.25 7.99805Z" stroke="#747678" stroke-width="1.24899" stroke-linecap="round" stroke-linejoin="round"/>
							<path d="M8 3.49805V7.99805L11 9.49805" stroke="#747678" stroke-width="1.24899" stroke-linecap="round" stroke-linejoin="round"/>
						</svg>
				...
				<svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
					<circle cx="7.5" cy="7.5" r="7.5" fill="#22668D"/>
				</svg>
			...
			>
				...
				>
					<LineSplitter text={"اخبار های مرتبط"} font_lg={24} font_md={22} font_sm={24} font_xs={16}/>
					<SimilarNews data={similar_article.data} />
				</Grid>
