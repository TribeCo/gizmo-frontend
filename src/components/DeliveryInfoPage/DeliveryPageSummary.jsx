                ...
                <Grid display='flex' alignItems='start'>
                    ...
                    >
                        <Grid
                            ...
                            columnGap={1}
                        >
                            <SvgIcon width="22" height="20" viewBox="0 0 22 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        >
                            ...
                            <div className="flex gap-2 w-full h-full">
                                ...
                                <button disabled className='bg-[#23CE6B] opacity-60 rounded-lg px-4 text-[#213346]'>
