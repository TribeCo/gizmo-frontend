        ...
        >
          ...
          <div className="flex border rounded-xl overflow-hidden h-9">
            ...
            <div className="bg-palette-blue w-[15%] flex items-center justify-center">
              <Image alt="search Icon" src={searchIcon} width={16}></Image>
            </div>
          </div>
        </Box>
              ...
              <Grid container spacing={2} sx={{ width: "100%" }}>
                <Grid item xs={12} md={6}>
                  <Typography
                    ...
                    align="left"
                  >
                    کد پیگیری: {toPersianDigits(order.ref_id)}
                    <span style={{ marginLeft: "20px", visibility: "hidden" }}>
                      A
                    </span>
                  </Typography>
                  <Typography
                    ...
                    align="left"
                  >
                    آدرس ارسال: <span style={{ marginRight: "20px" }}></span>
                    {`استان: ${order.address.province}, شهر: ${order.address.city}, آدرس: ${order.address.straight_address}, کد پستی: ${order.address.postal_code}`}
                  </Typography>
                  <Typography
                    sx={{
                      color: "#44434C",
                    ...
                    align="left"
                  >
                    نام گیرنده: <span style={{ marginRight: "30px" }}></span>
                  ...
                  <Typography
                    ...
                    align="left"
                  >
                    تاریخ سفارش: {toPersianDigits(order.shamsi_date)}
                    <span style={{ marginLeft: "2px", visibility: "hidden" }}>
                      A
                    </span>
                  </Typography>
                </Grid>
                ...
                >
                  <Typography
                    ...
                    align="left"
                  >
                    قیمت کل سفارش: {toPersianDigits(order.total_price)}
                  ...
                  <Typography
                    ...
                    align="left"
                  >
                    میزان تخفیف: {toPersianDigits(order.discount_amount)}
                    <span style={{ marginRight: "45px", visibility: "hidden" }}>
                      A
                    </span>{" "}
                    تومان
                  </Typography>
                  <Typography
                    ...
                    align="left"
                  >
                    مبلغ قابل پرداخت: {toPersianDigits(order.pay_amount)}
                    <span style={{ marginRight: "20px", visibility: "hidden" }}>
                      A
                    </span>{" "}
                    تومان
                ...
                <Grid
                  ...
                  sx={{
                    position: "relative",
                    bottom: { xs: "100px", sm: "165px", md: "0px" },
                    pr: { xs: "30px", sm: "20px", md: "0px" },
                ...
                >
                  <Typography
                    ...
                    align="right"
                  >
                    {toPersianDigits(order.total_price)} تومان
                  </Typography>
                  <Typography
                    sx={{
                      color: "#212121D6",
                    ...
                    align="right"
                  >
                    {toPersianDigits(order.discount_amount)} تومان
                  </Typography>
                  <Typography
                    sx={{
                      color: "#212121D6",
                    ...
                    align="right"
                  >
                    {toPersianDigits(order.pay_amount)} تومان
                  </Typography>
                </Grid>
              </Grid>
