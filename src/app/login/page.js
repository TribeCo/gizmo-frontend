	...
	return (
		<Box
			sx={{
				...
				width: "100vw",
				backgroundImage: {
					lg: `url("${baseUrl}/images/media/pictures/photo_2024-02-26_06-58-26.jpg")`, // Apply background image for lg and up
					md: `url("${baseUrl}/images/media/pictures/photo_2024-02-26_06-58-26.jpg")`, // Apply background image for md and up
