                ...
                >
                    ...
                    >   
                        ...
                        >
                            ...
                            >
                                <ArrowForwardIosOutlinedIcon sx={{ color: "white", fontSize: { xs: '12px', sm: '22px', md: '24px', lg: '26px' } }} />
                            </IconButton>
                            <IconButton
                                onClick={handlePrev}
                                sx={{
                            ...
                            >
                                <ArrowBackIosOutlinedIcon sx={{ color: "white", fontSize: { xs: '12px', sm: '22px', md: '24px', lg: '26px' } }} />
                            </IconButton>
                        </Grid>
                        <Grid
                            display='flex'
