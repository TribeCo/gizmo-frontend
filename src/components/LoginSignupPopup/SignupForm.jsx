...
import { TextField, Button, Link, Box, Typography, IconButton, FormControlLabel, Checkbox } from '@mui/material';
...
const SignupForm = ({ open, onClose, setPopupState }) => {
    ...
    const validationSchema = Yup.object().shape({
        ...
        phoneNumber: Yup.string().min(11, "تلفن همراه ۱۱ رقم است").max(11, "تلفن همراه ۱۱ رقم است").required('تلفن همراه الزامی است'),
        ...
        confirmation: Yup.string().oneOf([Yup.ref('password'), null], 'تکرار رمز عبور باید با رمز عبور مطابقت داشته باشد').required('تکرار رمز عبور الزامی است'),
        policyAgreed: Yup.boolean().oneOf([true], 'شما باید با قوانین سایت موافقت کنید'),
    });
