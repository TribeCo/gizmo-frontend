    ...
    return (
        <Box
            sx={{
                ...
                width: '100vw',
                backgroundImage: {
                    lg: `url("https://gn01.liara.run/images/media/pictures/photo_2024-02-26_06-58-05.jpg")`, // Apply background image for lg and up
                    md: `url("https://gn01.liara.run/images/media/pictures/photo_2024-02-26_06-58-05.jpg")`, // Apply background image for md and up
