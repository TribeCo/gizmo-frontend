    ...
    return (
        <Grid position='absolute'>
            ...
            >
                ...
                >
                    <DashBoardItems handleClose={handleClose} />


                    <Grid
                        sx={{
                            display: { xs: 'contents', lg: 'none' }
                        }}
                    >
...
const MenuItem = ({
    ...
    const linkCondition = ["دسته بندی ها", "داشبورد"];
    const innerItems = (
        <>
            <Grid
                display='flex'
    ...
    if (!linkCondition.includes(label)) {
        return (
            <>
