...
export default function DashBoardFactor({ id }) {
	...
	const handleGetFactors = async () => {
		try {
			...
			enqueueSnackbar({ message: "خطا در دریافت فاکتورها.", variant: "error" });
		}
	};
						...
						<Box display={{ xs: "none", md: "block" }}>
							<Grid
								...
								<Grid
									...
									xs={6}>
									<Typography
										sx={{ textAlign: "left", fontWeight: 700, fontSize: 14 }}>
										نام مشتری:{" "}
										<span style={{ fontWeight: 500 }}>
											{factors.user.full_name}
										</span>
									</Typography>
								</Grid>
								<Grid
								...
								<Grid
									...
									<Typography
										...
										آدرس:{" "}
										<span style={{ fontWeight: 500 }}>
											{formatFullAddress(factors.address)}
										</span>
									</Typography>
								</Grid>
								<Grid
