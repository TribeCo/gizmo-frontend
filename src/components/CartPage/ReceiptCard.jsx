...
const ReceiptCard = () => {
  ...
  return (
    ...
    >
      ...
      <Typography sx={{ marginBottom: { xs: '10px', sm: '', md: '', lg: '20px' }, fontWeight: 'bold', color: '#213346', letterSpacing: '-0.05rem', fontSize: { xs: '16px', sm: '18px', md: '21px', lg: '24px' } }}>
        فاکتور خرید شما
      </Typography>
      {/* Container for the two left-aligned Typography elements */}
      <Box sx={{ alignSelf: 'flex-start', marginLeft: '40px', padding: { xs: '10px', sm: '', md: '', lg: '20px' } }}>
        <Grid container spacing={2}>
          <Grid item xs={5}>
            <Typography sx={{ fontSize: { xs: '12px', sm: '15px', md: '18px', lg: '20px' }, fontWeight: '700', color: '#44434C', letterSpacing: '-0.05rem' }}>
              شیوه ارسال :
            </Typography>
          </Grid>
          <Grid item xs={5} sx={{ textAlign: 'center' }}>
            <Typography sx={{ fontSize: { xs: '13px', sm: '15px', md: '18px', lg: '20px' }, fontWeight: '500', color: '#44434C', letterSpacing: '-0.05rem' }}>
              پست پیشتاز
            </Typography>
          </Grid>
          <Grid item xs={5}>
          ...
          <Grid item xs={5} sx={{ textAlign: 'center' }}>
            <Typography sx={{ fontSize: { xs: '11px', sm: '13px', md: '15px', lg: '18px' }, fontWeight: '500', color: '#44434C', letterSpacing: '-0.05rem' }}>
      ...
      />
      <Box sx={{ alignSelf: 'flex-start', marginLeft: '30px', padding: { xs: '15px', sm: '20px', md: '25px', lg: '30px' } }}>
        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={6} sx={{ textAlign: 'center' }}>
            <Typography sx={{ fontSize: { xs: '12px', sm: '15px', md: '18px', lg: '20px' }, fontWeight: '500', color: '#44434C', letterSpacing: '-0.05rem' }}>
          ...
          <Grid item xs={6} sx={{ textAlign: 'center' }}>
            <Typography sx={{ fontSize: { xs: '16px', sm: '19px', md: '22px', lg: '24px' }, fontWeight: '700', color: '#44434C', letterSpacing: '-0.05rem' }}>
              {convertToPersian(398000)} تومان
            </Typography>
          </Grid>
        </Grid>
