			...
			<section className="w-[60rem] md:w-[24rem] py-4 px-3 flex flex-col lg:w-full rounded-xl">
				...
				<section className="flex flex-col mt-4 gap-4 overflow-scroll">
					{filteredOrders.map((product, index) => (
						<div
							key={index}
							className="OrderCard flex gap-6 px-6 py-6 bg-[#F7F7F7] hover:bg-[#0000000e] transition-all rounded-lg lg:flex-col md:gap-4">
							<div className="rightPart flex w-full flex-col items-end gap-4">
								<div className="infoRow flex justify-between w-full gap-[10%]">
									<span className="font-extrabold lg:text-sm whitespace-nowrap">
										کد پیگیری:{" "}
									</span>
								...
								<div className="infoRow flex justify-between w-full gap-[10%]">
									...
									<div
										...
										<Typography
											noWrap
											sx={{ maxWidth: "200px", direction: "rtl" }}>
											{product.link}
										</Typography>
									</div>
								</div>
							...
							<div className="leftPart w-full flex flex-col gap-4">
								<div className="infoRow flex justify-between w-full gap-[10%]">
									<span className="font-extrabold md:text-sm whitespace-nowrap">
										تاریخ استعلام:{" "}
									</span>
								...
								<div className="infoRow flex justify-between w-full gap-[10%]">
									<span className="font-extrabold lg:text-sm text-palette-blue whitespace-nowrap">
										قیمت نهایی با ارسال:{" "}
									</span>
